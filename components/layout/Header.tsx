    ...
    <header className={`${styles.headerBg} ${styles.headerBorder} sticky top-0 z-50 transition-colors duration-300`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex p-1 space-x-1 overflow-x-auto shrink-0 bg-slate-100 rounded-lg">
          ...
          <button onClick={() => handlePortfolioChange('TURTLE')} className={`flex items-center md:px-2 md:py-1 md:text-[10px] lg:px-4 lg:py-1.5 lg:text-sm font-medium transition-all whitespace-nowrap ${portfolioType === 'TURTLE' ? styles.buttonActive : styles.buttonInactive} rounded-md`} title="Żółwie"><Turtle size={16} /></button>
        </div>
